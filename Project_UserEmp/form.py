...
class empForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'national': forms.TextInput(attrs={'class': 'form-control', 'maxlength': '100',}),
            'ethnicity': forms.TextInput(attrs={'class': 'form-control', 'maxlength': '100',}),
            'religion': forms.TextInput(attrs={'class': 'form-control', 'maxlength': '100',}),
            ...
            'tel': forms.TextInput(attrs={'class': 'form-control', 'pattern': "[0-9]+",'minlength':'10','maxlength': '10',}),
